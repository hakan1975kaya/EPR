...
namespace Entities.Concrete.Dtos.PaymentRequestSummaryDtos.PaymentRequestSummaryGetByTodayDtos
{
    public class PaymentRequestSummaryGetByTodayResponseDto : IDto
    {
