...
namespace Business.ValidationRules.FluentValidation.PaymentRequestDetailDetailValidators
{
    public class PaymentRequestDetailUpdateRequestDtoValidator : AbstractValidator<PaymentRequestDetailUpdateRequestDto>
    {
        public PaymentRequestDetailUpdateRequestDtoValidator()
        {
